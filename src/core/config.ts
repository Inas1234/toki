...
import { z } from "zod";
import { BudgetMode, GlobalConfig, RepoConfig } from "./types.js";
import { ensureDir, fileExists, readTextFile, writeTextFile } from "../utils/fs.js";
...
const globalSchema = z.object({
  ...
  runtime: z
    .object({
      ...
      max_tool_rounds: z.number().int().positive().default(6),
      edit_tool_call_retries: z.number().int().min(0).default(2)
    })
    .default({
